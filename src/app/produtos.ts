...
export const produtos: IProduto[] = [
    ...
    { id: 8, descricao: "Combo de placa de ví­deos", preco: 18449.99, descricaoPreco: "Á vista no PIX",imagem: "./assets/placa-video.jpg", quantidadeEstoque: 10 },
    ...
    { id: 11, descricao: "Notebook excelente", preco: 4500, descricaoPreco: "Á vista no PIX",imagem: "./assets/laptop-2.jpg", quantidadeEstoque: 10 },
    { id: 12, descricao: "Mouse barato", preco: 20, descricaoPreco: "Á vista no PIX",imagem: "./assets/mouse-1.png", quantidadeEstoque: 10 },
    { id: 13, descricao: "Mouse Ótimo", preco: 200, descricaoPreco: "Á vista no PIX",imagem: "./assets/mouse-2.jpg", quantidadeEstoque: 10 },
    { id: 14, descricao: "Mouse pequeno", preco: 50, descricaoPreco: "Á vista no PIX",imagem: "./assets/mouse-4.jpg", quantidadeEstoque: 10 },
    { id: 15, descricao: "Teclado bom", preco: 159.99, descricaoPreco: "Á vista no PIX",imagem: "./assets/teclado-2.jpg", quantidadeEstoque: 10 },
]